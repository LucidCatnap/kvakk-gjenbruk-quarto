...
# Gjenbruk i egen kode {.title-middle-dark data-menu-title="Gjenbruk i egen kode"}

<!-- Slide 2 - KVAKK - Best practice -->
## Beste praksis {.centered .smaller data-menu-title="Beste praksis"}
...
## Gjenbruk i egen kode {data-menu-title="Gjenbruk i egen kode - fordeler"}
...
## Ti punkter om gjenbruk i egen kode {data-menu-title="Ti prinsipper for gjenbruk i egen kode"}
